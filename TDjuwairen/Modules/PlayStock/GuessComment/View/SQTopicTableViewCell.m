...
//        _nameLabel.textColor = [UIColor hx_colorWithHexRGBAString:@"#666666"];
        ...
        _topicLabel.textColor = [UIColor hx_colorWithHexRGBAString:@"#333333"];
        ...
        _commentTableView.backgroundColor = [UIColor hx_colorWithHexRGBAString:@"#f3f3f3"];
        _commentTableView.layer.cornerRadius = 4.0f;
        ...
        _dateTimeLabel.font = [UIFont systemFontOfSize:12.0f];
        _dateTimeLabel.textColor = [UIColor hx_colorWithHexRGBAString:@"#cccccc"];
        ...
        [_replyButton setTitleColor:[UIColor hx_colorWithHexRGBAString:@"#666666"] forState:UIControlStateNormal];
        [_replyButton setImage:[UIImage imageNamed:@"icon_reply.png"] forState:UIControlStateNormal];
        [_replyButton setTitle:@"回复" forState:UIControlStateNormal];
        _replyButton.titleEdgeInsets = UIEdgeInsetsMake(0, 8, 2, 0);
        [_replyButton addTarget:self action:@selector(replyPressed:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)replyPressed:(id)sender {
    if (self.delegate && [self.delegate respondsToSelector:@selector(cell:didReplyTopicClicked:)]) {
        [self.delegate cell:self didReplyTopicClicked:self.topicViewModel.topicModel];
    }
}
