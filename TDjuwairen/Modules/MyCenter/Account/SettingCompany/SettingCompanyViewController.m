//
//  SettingCompanyViewController.m
//  TDjuwairen
//
...
@implementation SettingCompanyViewController
...
- (void)viewDidLoad {
    ...
    self.textField.text = US.company;
...
- (void)donePressed:(id)sender {
    ...
    NSString *company = self.textField.text;
...
- (IBAction)textDidChange:(UITextField *)textField {
    self.navigationItem.rightBarButtonItem.enabled = ![textField.text isEqualToString:US.company];
}
