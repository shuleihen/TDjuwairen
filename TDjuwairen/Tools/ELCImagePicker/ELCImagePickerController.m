...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
//        NSString *title = [NSString stringWithFormat:NSLocalizedString(@"最多选择%d张照片哦!", nil), self.maximumImagesCount];
        NSString *message = [NSString stringWithFormat:NSLocalizedString(@"只能选择%d张照片", nil), self.maximumImagesCount];
