...
#define kFinishColor [UIColor colorWithRed:190/255.0 green:190/255.0 blue:190/255.0 alpha:1.0]
#define kSyncColor [UIColor colorWithRed:190/255.0 green:190/255.0 blue:190/255.0 alpha:1.0]
...
- (void)showCheckmark
{
    ...
    CGRect frame = CGRectMake(self.topRing.arcLayer.lineWidth * 2,
                              ...
                              self.bounds.size.width - self.topRing.arcLayer.lineWidth * 2,
                              self.bounds.size.height - self.topRing.arcLayer.lineWidth * 3.2);
